...
public class groupchat extends AppCompatActivity {
    ...
    private void prepareMovieData() {
        GroupChat movie = new GroupChat("Meesi","5 members");
        movieList.add(movie);

        movie = new GroupChat("Inesta","6 members");
        movieList.add(movie);

        movie = new GroupChat("Xavi","6 members");
        movieList.add(movie);

        movie = new GroupChat("Ronaldinho","7 members ");
        movieList.add(movie);
